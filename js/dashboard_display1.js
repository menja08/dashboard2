...
//playlist2
fetch("display_playlist2.php").then(result => result.text()).then(result => {
    const parser = new DOMParser();
    const htmlDocument = parser.parseFromString(result, "text/html");
    const section = htmlDocument.getElementById("playlist1");
    console.log(section);
...
//
// //playlist4
// fetch("display_playlist4.php").then(result => result.text()).then(result => {
//     const parser = new DOMParser();
//     const htmlDocument = parser.parseFromString(result, "text/html");
//     const section = htmlDocument.getElementById("playlist1");
//     console.log(section);
...
//
// //playlist5
// fetch("display_playlist5.php").then(result => result.text()).then(result => {
//     const parser = new DOMParser();
//     const htmlDocument = parser.parseFromString(result, "text/html");
//     const section = htmlDocument.getElementById("playlist1");
//     console.log(section);
